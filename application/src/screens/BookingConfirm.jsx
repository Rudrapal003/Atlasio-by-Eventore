...
const BookingConfirm = () => {
  ...
  // PRD §17: HST is collected by Eventore *on the facilitation fee only*.
    ...
    <div className="screen-body">
      ...
      <div className="s4-body" style={{ overflowY: 'auto' }}>
        ...
        <div className="s4-card">
          ...
          <div className="s4-row"><span>Eventore Facilitation Fee (5%)</span><span className="v">${Math.round(serviceFee).toLocaleString()}</span></div>
