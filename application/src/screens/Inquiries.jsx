        ...
        setInquiries([
          {
            id: 1,
            status: 'pending',
            profiles: { full_name: 'Sarah Connor' },
            events: { type: 'Wedding', date: '2026-08-15', guests: 150, location: 'Vancouver, BC' }
          },
          {
            id: 2,
            status: 'accepted',
            profiles: { full_name: 'John Smith' },
            events: { type: 'Corporate', date: '2026-09-01', guests: 200, location: 'Vancouver, BC' }
          }
        ]);
        setLoading(false);
        return;
    ...
    <div className="screen-body theme-creator">
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px' }}>
        {loading ? (
          ...
          <div key={inq.id} style={{ background: 'var(--glass-bg)', backdropFilter: 'var(--glass-blur)', borderRadius: '16px', border: '1px solid var(--line)', padding: '20px', marginBottom: '16px' }}>
