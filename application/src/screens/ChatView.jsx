  ...
  useEffect(() => {
    ...
    const fetchMessages = async () => {
      ...
      if (localStorage.getItem('QA_MODE') === 'true') {
        setMessages([
          { id: 1, sender_id: 'other', body: 'Hi, are you available?', created_at: new Date(Date.now() - 3600000).toISOString() },
          { id: 2, sender_id: currentUserId, body: 'Yes I am!', created_at: new Date(Date.now() - 1800000).toISOString() }
        ]);
        setLoading(false);
        return;
      }
