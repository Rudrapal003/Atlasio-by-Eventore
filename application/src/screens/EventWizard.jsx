          ...
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, margin: '12px 0' }}>
              <button
                ...
                style={{ width: 36, height: 36, borderRadius: 18, border: '1px solid var(--line)', background: 'var(--glass-bg)', backdropFilter: 'var(--glass-blur)', fontSize: 22, lineHeight: 1, cursor: 'pointer', color: 'var(--ink)' }}
                aria-label="Decrease"
              >−</button>
              <input
                type="number"
