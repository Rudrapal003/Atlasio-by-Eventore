...
// Customer files, vendor gets 7 days to respond, Eventore support decides.
const REASONS = [
    ...
    return (
      <div className="screen-body" style={{ alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '40px 24px' }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: 14, lineHeight: 1.5, maxWidth: 280 }}>
          ...
          Eventore Support will review and decide within 14 days.
        </p>
    ...
    <div className="screen-body">
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '16px 20px' }}>
        ...
        {step === 2 && (
          <>
            ...
            <p style={{ fontSize: 12, color: 'var(--muted)', margin: '0 0 12px' }}>Be specific. Eventore Support and the vendor will both see this.</p>
            <textarea
              value={details}
      ...
      <div style={{ padding: '12px 20px 24px', borderTop: '1px solid var(--line)', background: 'var(--glass-bg)', backdropFilter: 'var(--glass-blur)' }}>
        ...
        <p style={{ textAlign: 'center', fontSize: 11, color: 'var(--muted)', margin: '8px 0 0' }}>
          Eventore's decision is binding for in-app booked events.
        </p>
      </div>
    </div>
  );
