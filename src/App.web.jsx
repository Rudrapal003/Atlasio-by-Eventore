...
function App() {
  ...
  useEffect(() => {
    ...
    try {
      const savedState = localStorage.getItem('evently_state');
      if (savedState) {
      ...
      console.warn('Failed to restore Evently state:', e);
    }
  ...
  useEffect(() => {
    try {
      localStorage.setItem('evently_state', JSON.stringify(state));
    } catch (e) {
      console.warn('Failed to persist Evently state:', e);
    }
  }, [state]);
            ...
            <div className="screen">
              <div className="status-bar">
                ...
                <div className="right">
                  ...
                  <svg width="27" height="12" viewBox="0 0 27 12"><rect x="0.5" y="0.5" width="22" height="11" rx="2.5" fill="none" stroke="currentColor" stroke-opacity=".5"/><rect x="2" y="2" width="17" height="8" rx="1.5" fill="currentColor"/><rect x="23.5" y="3" width="2" height="6" rx="1" fill="currentColor" fill-opacity=".5"/></svg>
                </div>
              </div>
              <ErrorBoundary>
              <Routes>
