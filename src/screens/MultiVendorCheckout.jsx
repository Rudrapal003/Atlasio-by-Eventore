    ...
    <div className="screen-body">
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '16px 20px' }}>
        ...
        <div className="s4-card" style={{ marginTop: 8 }}>
          ...
          <div className="s4-row"><span>Evently Facilitation Fee (5%)</span><span className="v">${Math.round(totals.facilitation).toLocaleString()}</span></div>
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 12, padding: 10, background: '#F0F9FF', border: '1px solid #BAE6FD', borderRadius: 10, fontSize: 11, color: '#075985' }}>
          ...
          <div>
            <b>Backup vendor guarantee:</b> if any confirmed vendor cancels, Evently sources a replacement within 4 hours.
          </div>
        </div>
      </div>
